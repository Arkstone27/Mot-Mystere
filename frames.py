...
class FrameInfo(ctk.CTkFrame):
    def __init__(self, master, pseudo,  **kwargs):
        ...
        self.frame_droit = ctk.CTkFrame(self, fg_color="transparent")
        ...
        self.frame_droit.pack(side="right", expand=True, pady=(20,0))
        ...
        ctk.CTkLabel(self.frame_gauche, text="Session : " + pseudo, font=("Courier", 16, "bold")).pack()
        self.frame_gauche.pack(side="left", padx=(20,0), pady=(20,0))
